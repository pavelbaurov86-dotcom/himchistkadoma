  ...
  <div class="header-shell">
    <div class="header-inner">
      <a class="logo" href="index.html">
        <div class="logo-icon" aria-hidden="true">HD</div>
        <div>
...
SERVICES = {
    "himchistka-divanov.html": {
        ...
        "cards": [
            {"icon": ICON_SOFA, "tag": "Хит", "title": "Прямой диван", "text": "2–3 посадочных места, стандартная чистка с экстракцией.", "price": "от 3&nbsp;500&nbsp;₽", "unit": "за диван"},
            {"icon": ICON_SOFA, "tag": "Популярно", "title": "Угловой диван", "text": "Угловые и П-образные. Учитываем подушки и спальное место.", "price": "от 4&nbsp;500&nbsp;₽", "unit": "за диван"},
            {"icon": ICON_SOFA, "title": "Диван-кровать", "text": "Выкатные и раскладные модели. Чистим сиденье и спальную зону.", "price": "от 4&nbsp;000&nbsp;₽", "unit": "за диван"},
            {"icon": ICON_SPARK, "title": "Локальная чистка пятен", "text": "Точечная обработка сложных пятен без полной мойки всего изделия.", "price": "от 1&nbsp;500&nbsp;₽", "unit": "за зону"},
        ],
        "faq": SOFA_FAQ,
        "seo_paras": [
    ...
    "himchistka-matrasov.html": {
        ...
        "cards": [
            {"icon": ICON_MATTRESS, "tag": "Стандарт", "title": "Одна сторона", "text": "Чистка рабочей стороны матраса любой жёсткости.", "price": "от 1&nbsp;500&nbsp;₽", "unit": "за сторону"},
            {"icon": ICON_MATTRESS, "tag": "Рекомендуем", "title": "Две стороны", "text": "Полная обработка матраса с двух сторон.", "price": "от 2&nbsp;800&nbsp;₽", "unit": "за матрас"},
            {"icon": ICON_MATTRESS, "title": "Детский матрас", "text": "Мягкая химия, аккуратная сушка. Для детских и подростковых.", "price": "от 1&nbsp;200&nbsp;₽", "unit": "за сторону"},
            {"icon": ICON_SPARK, "title": "Удаление запахов", "text": "Нейтрализация запахов и глубокая экстракция проблемных зон.", "price": "от 2&nbsp;000&nbsp;₽", "unit": "за матрас"},
        ],
        "faq": MATTRESS_FAQ,
        "seo_paras": [
    ...
    "himchistka-kovrov.html": {
        ...
        "cards": [
            {"icon": ICON_CARPET, "tag": "Ковры", "title": "Ковёр с коротким ворсом", "text": "Стандартная чистка с экстракцией.", "price": "от 350&nbsp;₽", "unit": "за м²"},
            {"icon": ICON_CARPET, "title": "Длинный ворс / шегги", "text": "Более тщательная проработка и сушка.", "price": "от 450&nbsp;₽", "unit": "за м²"},
            {"icon": ICON_CARPET, "title": "Палас / дорожка", "text": "Чистка без вывоза, аккуратно по краям.", "price": "от 350&nbsp;₽", "unit": "за м²"},
            {"icon": ICON_SPARK, "title": "Сложные пятна", "text": "Локальная обработка пятен и запахов.", "price": "по оценке", "unit": ""},
        ],
        "faq": CARPET_FAQ,
        "seo_paras": [
    ...
    "himchistka-kresel-i-stulev.html": {
        ...
        "cards": [
            {"icon": ICON_CHAIR, "tag": "Дом", "title": "Стул мягкий", "text": "Сиденье и спинка. Идеально для комплектов.", "price": "от 300&nbsp;₽", "unit": "за шт."},
            {"icon": ICON_CHAIR, "title": "Кресло домашнее", "text": "Посадочное место, подлокотники, спинка.", "price": "от 800&nbsp;₽", "unit": "за шт."},
            {"icon": ICON_CHAIR, "tag": "Офис", "title": "Офисное кресло", "text": "Ткань или сетка. Выезд в офис возможен.", "price": "от 700&nbsp;₽", "unit": "за шт."},
            {"icon": ICON_SPARK, "title": "Комплект от 6 шт.", "text": "Скидка на комплексную чистку стульев.", "price": "скидка до 15%", "unit": ""},
        ],
        "faq": CHAIR_FAQ,
        "seo_paras": [
